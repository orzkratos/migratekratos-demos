...
+	"github.com/orzkratos/demokratos/demo1kratos/internal/pkg/appcfg"
...
## cmd/demo1kratos/subcmds/sub_cmds.go (+106 -0)
...
## scripts/20251110101144_create_table.down.sql (+5 -0)
...
## scripts/20251110101144_create_table.up.sql (+10 -0)
